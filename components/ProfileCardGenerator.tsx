...
export default function ProfileCardGenerator() {
  const [cardImage, setCardImage] = useState(
    '/api/profile?login=aamoussa&cursus=42cursus&email=hide'
  )
      ...
      <div className="flex">
        <div className="mr-5">
          ...
          <div
            ...
            style={{ maxWidth: 450 }}
          >
            [![42 Profile Card](https://1337-readme-hxx2.vercel.app{cardImage}
              ...
              <div className="mb-5">
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <option value="c-piscine">C Piscine</option>
